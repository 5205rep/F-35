...
var rudder = getprop("/fdm/jsbsim/fcs/rudder-pos-norm");
...
#screen.log.write("VTOL ease of control enabled",1,1,1);
} else {
...
setprop("/fdm/jsbsim/propulsion/engine[0]/pitch-angle-rad", 1.5707*thrust);
